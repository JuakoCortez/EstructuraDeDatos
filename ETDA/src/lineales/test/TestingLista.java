...
public class TestingLista {
    static String sOk = "OK!", sErr = "ERROR";
	    ...
	    public static void testLista() {
	        ...
	        System.out.println("\t--> " + l1.toString());
	        System.out.println("Inserta 10 pos 0 espera FALSE: \t\t\t" + ((l1.insertar(10, 0) == false) ? sOk : sErr));
            ...
            public static Lista armarLista(Pila pila1){
                ...
                Pila pilaClon=pila1.clone();
                Object objetoActual=pilaClon.obtenerTope();
                int i=1,posicion=1,posicion2=1;
                while(!pilaClon.esVacia()){
                    
                    if(objetoActual.equals('&')){
                        i++;
                        listaNueva.insertar('&', posicion);
                        posicion++;
                        posicion2=posicion;
                    }
                    if(!(i%2==0)){
                        listaNueva.insertar(objetoActual, posicion2);
                        posicion++;
                    }else{
                        listaNueva.insertar(objetoActual, posicion);
                        posicion++;
                    }
                    pilaClon.desapilar();
                    objetoActual=pilaClon.obtenerTope();
                }
                return listaNueva;
            }
}
